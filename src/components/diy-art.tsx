  ...
  return (
    <svg viewBox="0 0 96 96" className={className} fill="none" aria-hidden="true">
      <path
        ...
        strokeWidth="2.5"
      />
      <rect x="32" y="20" width="32" height="7" rx="2.5" stroke="#2f7a45" strokeWidth="2.5" />
...
export function MaterialSoilArt({ className }: ArtProps) {
  return (
    <svg viewBox="0 0 96 96" className={className} aria-hidden="true">
      ...
      <path d="M30 56c3-7 9-11 18-11" stroke="#8a6142" strokeWidth="3" strokeLinecap="round" fill="none" />
      <circle cx="40" cy="60" r="2" fill="#8a6142" />
      <circle cx="56" cy="58" r="2" fill="#553a24" />
      <path d="M18 66h60" stroke="#4a3421" strokeWidth="3" strokeLinecap="round" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 96 96" className={className} aria-hidden="true">
      ...
      <path
        ...
        fill="none"
      />
      <path d="M64 52c6 2 10 6 11 11" stroke="#c9a26e" strokeWidth="3" strokeLinecap="round" fill="none" />
    </svg>
  );
}
...
export function IdeaLanternArt({ className }: ArtProps) {
  return (
    <svg viewBox="0 0 96 96" className={className} aria-hidden="true">
      ...
      <path d="M32 22h32v44a6 6 0 0 1-6 6H38a6 6 0 0 1-6-6V22Z" fill="#d8c9a8" />
      <rect x="28" y="16" width="40" height="8" rx="3" fill="#b49a68" />
      <circle cx="48" cy="52" r="9" fill="#f2b64b" />
      <path d="M48 47v10M44 50l8 4" stroke="#fff3d6" strokeWidth="2" strokeLinecap="round" />
      <path d="M38 78h20" stroke="#8f7b52" strokeWidth="4" strokeLinecap="round" />
    </svg>
  );
}
...
export function IdeaHangingLightsArt({ className }: ArtProps) {
  return (
    <svg viewBox="0 0 96 96" className={className} aria-hidden="true">
      ...
      <path d="M0 20c20 8 76 8 96 0" stroke="#3d5a38" strokeWidth="3" fill="none" />
...
export function IdeaStorageJarArt({ className }: ArtProps) {
  return (
    <svg viewBox="0 0 96 96" className={className} aria-hidden="true">
      ...
      <rect x="26" y="48" width="12" height="18" rx="2" fill="#e8b64c" opacity="0.7" />
      <rect x="56" y="54" width="12" height="14" rx="2" fill="#c96f4a" opacity="0.6" />
    </svg>
  );
}
