import {
  ...
  CameraHeader,
  ScanGuide,
} from "@/components/camera-components";
...
export default function TakePhotoPage() {
  return (
    <div className="flex min-h-dvh bg-page pb-20 md:pb-0">
      ...
      <main className="min-w-0 flex-1 px-5 py-8 lg:px-7 lg:py-8">
        <CameraHeader />
        <div className="mt-7 grid grid-cols-1 gap-7 xl:grid-cols-[minmax(0,1.55fr)_minmax(360px,.73fr)]">
          <CameraCapture />
          <ScanGuide />
        </div>
      </main>
